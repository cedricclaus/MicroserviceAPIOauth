...
To optimize the MicroserviceAPIOauth application for production, run:
...
Then navigate to [http://localhost:8485](http://localhost:8485) in your browser.
